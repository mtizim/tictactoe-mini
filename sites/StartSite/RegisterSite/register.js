...
function doRegisterForm() {
  ...
  // (B2) APPEND FIELDS
  registerdata.append("username", document.getElementById("username_col").value);
  registerdata.append("password", document.getElementById("password_col").value);

  // wypisać
  for (let [k, v] of registerdata.entries()) { console.log(k, v); }
